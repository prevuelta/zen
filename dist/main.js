...
},{"../shaders/water.frag":17,"../shaders/water.vert":18,"../util/patchedThree":21}],10:[function(require,module,exports){
'use strict';
...
},{"../abstract/Field":8,"../abstract/entropy":7,"../util/cross":19,"three":"three"}],12:[function(require,module,exports){
'use strict';
...
module.exports = Rock;
},{"../abstract/Field":8,"../abstract/entropy":7,"../shaders/test.frag":15,"../shaders/test.vert":16,"../util/cross":19,"../util/patchedThree":21,"../util/util":23,"quickhull3d":"quickhull3d","three-subdivision-modifier":"three-subdivision-modifier"}],13:[function(require,module,exports){
'use strict';
...
function Terrain (size, baseAmp, heightAmp) {
    ...
    for (let i = 0; i < size; i++) {
        for (let j = 0; j < size; j++) {
            x = i*baseAmp;
            y = 4;//Math.floor(heightMap[i][j] * heightAmp);
            z = j*baseAmp;
            // if (!j)
...
},{"../util/displacement":20,"../util/patchedThree":21,"../util/util":23,"three-subdivision-modifier":"three-subdivision-modifier"}],14:[function(require,module,exports){
'use strict';
...
},{"./elements/water":9,"./flora/grass":10,"./geology/cobble":11,"./geology/rock":12,"./geology/terrain":13,"./util/shape2mesh":22,"./util/util":23,"cannon":"cannon","stats-js":5,"three":"three","three-orbit-controls":6}],15:[function(require,module,exports){
